  ...
  Future<void> _onCreateAccount() async {
    ...
    if (fullName.isEmpty || email.isEmpty || password.isEmpty || _selectedRole == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Please complete all fields and select a role.')),
      );
      return;
    }
...
class _RoleOption extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final borderColor = selected ? AppColors.orange : AppColors.plum.withValues(alpha: 0.65);
